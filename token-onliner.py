...
def status_changer(ws: websocket.WebSocket):
    status = ["online", "idle", "dnd"]
    quotes = ["github.com/aditya-pushkar", "guilded.gg/aditya-pushkar", "discord.com/terms", "<3", "github.com/aditya-pushkar", "guilded.gg/aditya-pushkar", "github.com/aditya-pushkar"]
    while True:
